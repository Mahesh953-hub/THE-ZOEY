        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('• ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ •', url ='https://telegram.me/movieworldop')
                        ]]
                    )
                )
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("• ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ • ​ ", url=f"https://telegram.me/movieworldop")]]), disable_web_page_preview=True
    )
...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn.insert(0, [
            InlineKeyboardButton("ᴘʀᴇᴍɪᴜᴍ", url=f"https://t.me/ONLY_KAILASHHH"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url="https://t.me/movieworldop")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @cryxelys
        ...
        buttons = [[
            InlineKeyboardButton('× ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ ×', url="https://t.me/CNNETWORKS")
       ],[
            InlineKeyboardButton('• ɢʀᴏᴜᴘ •', url="t.me/CN_DISCUSSION"),
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs •', url="t.me/movieworldop")
       ],[
            InlineKeyboardButton('• sᴜᴘʀᴇᴍᴇsᴄʀᴇᴇɴ •', url="https://t.me/SupremeScreen"),
            InlineKeyboardButton('• ᴍᴏᴠɪᴇs •', url="https://t.me/movieworldop")
       ],[
            InlineKeyboardButton('• ʀᴀᴏsᴀʜᴀʙ •', url="https://t.me/CNxONWER")
       ],[ 
            InlineKeyboardButton('• ʙᴀᴄᴋ •', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            ...
            InlineKeyboardButton ('• ᴠɪsɪᴛ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ •', url="t.me/CNNETWORKS"),
        ], [
            InlineKeyboardButton('• ᴏᴡɴᴇʀ •', user_id=int(6340125899)),
    ...
    elif query.data == "ᴏᴡɴᴇʀ ᴊɪɪ":
        buttons = [[
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='help'),
            InlineKeyboardButton('ᴏᴡɴᴇʀ', url="t.me/ONLY_KAILASHHH")
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await client.edit_message_media(
            query.message.chat.id, 
